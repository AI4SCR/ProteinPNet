...
"""
Helper script that takes a folder as input and generates a on the dna-free, arcsinh'ed, 
"""

def gen_normed_image(patient_id, output_dir, stats):
...
if __name__ == "__main__":
    ...
    stats = joblib.load("/work/FAC/FBM/DBC/mrapsoma/prometex/projects/ProtoPNet/preprocessing_stats_43dim.joblib")
    for img_pth in tqdm(Path('/work/FAC/FBM/DBC/mrapsoma/prometex/data/NSCLC/02_processed/images/images_mcd_masked').glob("*.tiff")):
        ...
        gen_normed_image(patient_id, '/work/FAC/FBM/DBC/mrapsoma/prometex/data/NSCLC/02_processed/images/images_mcd_masked_normed_43dim', stats)
    print("...done.")\
